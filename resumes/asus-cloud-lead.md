...
**資深後端工程師｜跨專案交付・SaaS 整合・開發流程改善**

新北市 · [henry255164@gmail.com](mailto:henry255164@gmail.com) · [LinkedIn](https://www.linkedin.com/in/henry255164)

## 專業摘要

具備金融科技與 CRM 跨專案整合、SaaS 轉型及 Kubernetes 部署經驗。曾擔任組內 SaaS 轉型主要負責人，建立一鍵開發環境，並獨立交付帳號安全功能。能跨 React、PHP／Java API、資料庫與部署流程完成開發，以可恢復工作流、自動化測試及漸進式重構改善交付品質。
...
- 建立並開源一鍵開發環境，整合 8 個 PHP 專案、3 種 PHP 版本、2 個 Java 專案及多個前端、WebSocket 與資料庫服務，統一環境建置方式。
- 整合多個服務的代理推薦關係與帳戶流程，建立具狀態、冪等、checkpoint 及失敗恢復的非同步工作流；提供 reconciliation、只讀稽核及可續跑 backfill，支援資料修復與營運排查。
- 跨 React／TypeScript、PHP 與 Java 17／Spring Boot 完成 API 及介面開發，以 PHPUnit、JUnit、Jest 交付測試，並建立 Playwright 註冊與 KYC 自動化流程；與 AI 協作驗證並修正跨系統登入狀態問題。
- 重構 CRM 查詢、共用帳戶建立邏輯及產品生命週期資料，移除停用的獎勵流程；處理舊版 PHP／Laravel、MySQL 與設定快取相容性，並協作 SRE 改善資料庫及日誌維運。
...
- **系統開發**：PHP／Laravel、Java 17／Spring Boot、React／TypeScript、MySQL、Keycloak、冪等工作流、Queue、RabbitMQ。
- **品質與部署**：PHPUnit、JUnit、Jest、Playwright、Kubernetes、Docker、Terraform、GitLab CI/CD、GCP／AWS。
